...
--inserir dados na tabela agendamentos
INSERT INTO Agendamentos (paciente_id, medico_id, data_hora, tipo_consulta, status) VALUES
(1, 1, '2024-03-10 11:00:00', 'check up geral', 'Agendado'),
(2, 2, '2024-03-12 15:30:00', 'Exame prostata', 'Agendado'),
(3, 3, '2024-03-15 19:00:00', 'Consulta ginecológica', 'Agendado'),
(4, 4, '2024-03-11 12:00:00', 'Consulta Cerebral', 'Agendado'),
(5, 5, '2024-03-13 17:00:00', 'Consulta ginecológica', 'Agendado');

--listar a quantidade de consultas por medico 



-- listar a quantidade de consultas por paciente
SELECT pacientes.nome, COUNT(Agendamentos.id) FROM pacientes JOIN agendamentos ON pacientes.id = agendamentos.paciente_id GROUP BY pacientes.nome ORDER BY pacientes.id;